{ config, lib, pkgs, cfg, ... }:
{
  home.file.".aria2/scripts" = {
    source = cfg.lib.relativeToRoot "dot/${cfg.sys.config}/aria2/scripts";
    recursive = true;
  };
